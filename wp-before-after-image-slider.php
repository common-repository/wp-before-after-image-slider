...
final class Plugin {
	...
	private function register_all_hooks() {
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'register_default_dependencies' ) );
	...
	public function register_common_dependencies(): array {
		...
		wp_register_script( 'coca-bais-lib-move', "$this->output_path/lib/js/jquery.event.move.js", $core_deps_scripts, $this->version, $is_in_footer );
		wp_register_script( 'coca-bais-lib-imageloaded', "$this->output_path/lib/js/imagesloaded.pkgd.min.js", array(), $this->version, $is_in_footer );
...
if ( ! function_exists( 'coca_bais_global_assets' ) ) :
	...
	function coca_bais_global_assets(): array {
		return array(
			'orientation' => array(
				'hr' => COCA_BAIS_URL . 'assets/lib/images/Horizontal.png',
				'vr' => COCA_BAIS_URL . 'assets/lib/images/Vertical.png',
			),
			'templates'   => array(
				'st01' => COCA_BAIS_URL . 'assets/lib/images/1.png',
				'st02' => COCA_BAIS_URL . 'assets/lib/images/2.png',
				'st03' => COCA_BAIS_URL . 'assets/lib/images/3.png',
				'st04' => COCA_BAIS_URL . 'assets/lib/images/4.png',
				'st05' => COCA_BAIS_URL . 'assets/lib/images/5.png',
				'st06' => COCA_BAIS_URL . 'assets/lib/images/6.png',
				'st07' => COCA_BAIS_URL . 'assets/lib/images/7.png',
				'st08' => COCA_BAIS_URL . 'assets/lib/images/8.png',
			),
		);
	}
endif;
